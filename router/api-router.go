...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		logRoute.GET("/capture/preview", middleware.AdminAuth(), middleware.RequirePermission(authz.UsageLogCaptureView), controller.PreviewDiagnosticCapture)
		logRoute.GET("/capture/download", middleware.AdminAuth(), middleware.RequirePermission(authz.UsageLogCaptureView), controller.DownloadDiagnosticCapture)
