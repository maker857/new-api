...
export function EmptyState(props: EmptyStateProps) {
  ...
  return (
    <div className='border-border/70 flex min-h-[320px] flex-col items-center justify-center rounded-lg border border-dashed bg-[#fcfcfd] px-6 py-12 text-center shadow-xs'>
