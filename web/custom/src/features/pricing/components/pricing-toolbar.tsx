...
function SegmentedControl(props: {
  ...
  return (
    <div
      ...
      className='border-border/70 bg-muted/25 inline-flex h-8 items-center rounded-md border p-0.5'
    >
...
export function PricingToolbar(props: PricingToolbarProps) {
  ...
  return (
    <div className='border-border/70 rounded-lg border bg-[#fcfcfd] p-3 shadow-xs'>
