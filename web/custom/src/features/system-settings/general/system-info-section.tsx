...
const _systemInfoSchema = z.object({
  theme: z.object({
    frontend: z.enum(['default', 'classic', 'custom']),
  }),
...
export function SystemInfoSection({ defaultValues }: SystemInfoSectionProps) {
  ...
  const frontendTheme = defaultValues.theme?.frontend
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {t(
                        'Switch between frontend skins. After saving, reload from the home page so the selected skin can load on a compatible route.'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder='欢迎使用 Kalos AI 服务平台...'
                          rows={6}
                          {...field}
                        />
                      </FormControl>
