            ...
            <FormField
              ...
              render={({ field }) => (
                <div className='space-y-2'>
                  ...
                  <FormDescription>
                    模式 1 需要监控服务器能访问当前服务；模式 2 适合本地电脑没有公网 IP 时测试，Kalos 会主动访问监控服务器。
                  </FormDescription>
                  <FormMessage />
                </div>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <div className='space-y-3'>
                                      ...
                                      onValueChange={(value) =>
                                        field.onChange(
                                          updateReplacementRuleJSON(
                                            field.value,
                                            monitorRule,
                                            { error_type_mode: value ?? undefined }
                                          )
                                        )
                                      }
                                    >
                                      ...
                                      onValueChange={(value) =>
                                        field.onChange(
                                          updateReplacementRuleJSON(
                                            field.value,
                                            monitorRule,
                                            { error_code_mode: value ?? undefined }
                                          )
                                        )
                                      }
                                    >
                                      ...
                                      onValueChange={(value) =>
                                        field.onChange(
                                          updateReplacementRuleJSON(
                                            field.value,
                                            monitorRule,
                                            { error_param_mode: value ?? undefined }
                                          )
                                        )
                                      }
                                    >
                  ...
                  <FormDescription>
                    {t(
                      'These filter rules are synchronized from the monitoring system. Kalos only configures the message and optional status code returned after a rule is matched.'
                    )}
                  </FormDescription>
                  <FormMessage />
                </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <div className='space-y-2'>
                  ...
                  <FormDescription>
                    模式 2 使用这个地址。Kalos 会按设置的间隔拉取黑名单规则，并保存到本地数据库。
                  </FormDescription>
                  <FormMessage />
                </div>
              )}
